...
table relokit_capability {
  ...
  index = [
    ...
    {type: "btree", field: [{name: "registry_version", op: "asc"}, {name: "constraint_type", op: "asc"}]}
    {type: "btree|unique", field: [{name: "capability_id", op: "asc"}, {name: "registry_version", op: "asc"}]}
  ]
